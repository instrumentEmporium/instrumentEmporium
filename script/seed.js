...
async function seed() {
  ...
  const instruments = await Promise.all([
    ...
    Instrument.create({ name: 'Guitar', type: 'String', price: '150', quantity: '15', imageUrl: 'https://images-na.ssl-images-amazon.com/images/I/41XHEir16vL._AC_US218_.jpg', description: 'This is a very nice guitar', rating: '3', audioUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/53/Classical_guitar_scale.ogg' }),
    ...
    Instrument.create({ name: 'Saxophone', type: 'Woodwind', price: '400', quantity: '9', imageUrl: 'https://images-na.ssl-images-amazon.com/images/I/41aGyE3ftQL._AC_US218_.jpg', description: 'This is a very nice saxophone', rating: '4', audioUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/bc/Basinstreetblues-first8bars.ogg' }),
    Instrument.create({ name: 'Flute', type: 'Woodwind', price: '115', quantity: '52', imageUrl: 'https://images-na.ssl-images-amazon.com/images/I/31u8h5eHinL._AC_US218_.jpg', description: 'This is a very nice flute', rating: '3', audioUrl: 'https://upload.wikimedia.org/wikipedia/commons/7/7d/Bach_-_Partita_For_Solo_Flute_-_Modern_Flute_-_1._Allemande.ogg' }),
    ...
    Instrument.create({ name: 'Harp', type: 'String', price: '900', quantity: '7', imageUrl: 'https://images-na.ssl-images-amazon.com/images/I/41GB31UTFZL._AC_US218_.jpg', description: 'This is a very nice harp', rating: '3', audioUrl: 'https://upload.wikimedia.org/wikipedia/commons/8/8c/17929B-Fantasia.ogg' }),
    ...
    Instrument.create({ name: 'Didgeridoo', type: 'Woodwind', price: '50', quantity: '72', imageUrl: 'https://www.tigermusic.co.uk/images/product/large/MDI001.jpg', description: 'This is a very fine didgeridoo', rating: '4', audioUrl: 'https://upload.wikimedia.org/wikipedia/commons/b/be/Hidden_Tribe_-_Didgeridoo_1_Live.ogg' }),
    ...
    Instrument.create({ name: 'Bagpipes', type: 'Woodwind', price: '1499', quantity: '7', imageUrl: 'https://images-na.ssl-images-amazon.com/images/I/61xwe6wcpYL._SL1000_.jpg', description: 'This is a very fine and expensive bagpipe', rating: '4', audioUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/54/Shepherd-pipe.ogg' }),
    ...
    Instrument.create({ name: 'Organ', type: 'Keyboard', price: '2500', quantity: '3', imageUrl: 'http://www.stmartinoftourschurch.org/wp-content/uploads/2011/12/Organ-Console.jpg', description: 'This is a very nice organ', rating: '5' , audioUrl: 'https://commons.wikimedia.org/wiki/File:BWV_621_organ.ogg'}),
    Instrument.create({ name: 'Harpsichord', type: 'Keyboard', price: '550', quantity: '5', imageUrl: 'http://www.baroquemusic.org/Hieronymus%20Albrecht%20Hass%20Harpsichord%20(Hamburg,%201740).jpg', description: 'This is a very nice harpsichord', rating: '4' , audioUrl: 'https://upload.wikimedia.org/wikipedia/commons/a/a1/De-Harpsichord.ogg'})
  ])
