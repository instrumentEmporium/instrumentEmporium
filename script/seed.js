...
async function seed () {
  ...
  // and store the result that the promise resolves to in a variable! This is nice!
    ...
    const instruments = await Promise.all([
      Instrument.create({name: 'Piano', type: 'Keyboard', price: '250', quantity: '24', imageUrl: 'https://www.yamaha.com/en/musical_instrument_guide/common/images/piano/parts_viewer01.jpg', description: 'This is a very nice piano', rating: '4'}),
      Instrument.create({name: 'Guitar', type: 'String', price: '150', quantity: '15', imageUrl: 'https://www.long-mcquade.com/files/10372/lg_V3_EN_C40.jpg', description: 'This is a very nice guitar', rating: '3'}),
      Instrument.create({name: 'Violin', type: 'String', price: '350', quantity: '37', imageUrl: 'https://thefinancialconsulting.com/wp-content/uploads/2018/02/Violin-Market.jpg', description: 'This is a very nice violin', rating: '4'}),
      Instrument.create({name: 'Saxophone', type: 'Woodwind', price: '400', quantity: '9', imageUrl: 'http://wpmanager.buffet-group.com/buffet/wp-content/uploads/sites/4/2016/05/bc8101_full-1592x600.jpg', description: 'This is a very nice saxophone', rating: '4'}),
      Instrument.create({name: 'Flute', type: 'Woodwind', price: '115', quantity: '52', imageUrl: 'https://www.thomann.de/pics/bdb/280440/5650888_800.jpg', description: 'This is a very nice flute', rating: '3'}),
      Instrument.create({name: 'Drums', type: 'Percussion', price: '1500', quantity: '22', imageUrl: 'https://www.stebaldrums.com/wp-content/uploads/2015/04/45th-1.jpg', description: 'This is a very nice pair of drums', rating: '5'}),
      Instrument.create({name: 'Harp', type: 'String', price: '900', quantity: '7', imageUrl: 'https://www.salviharps.com/wp-content/uploads/2016/05/Rainbow_SG.jpg', description: 'This is a very nice harp', rating: '3'}),
      Instrument.create({name: 'Trombone', type: 'Brass', price: '2800', quantity: '4', imageUrl: 'https://az58332.vo.msecnd.net/e88dd2e9fff747f090c792316c22131c/Images/Products1274-1200x1200-725532.jpg', description: 'This is one of the best trombones out there', rating: '5'}),
      Instrument.create({name: 'Ukulele', type: 'String', price: '80', quantity: '41', imageUrl: 'https://media.guitarcenter.com/is/image/MMGS7/MU40-Soprano-Ukulele-Natural/J22069000001000-00-500x500.jpg', description: 'This is a very nice ukulele', rating: '4'}),
      Instrument.create({name: 'Trumpet', type: 'Brass', price: '999', quantity: '19', imageUrl: 'https://images.reverb.com/image/upload/s---haqclbt--/a_exif,c_limit,e_unsharp_mask:80,f_auto,fl_progressive,g_south,h_620,q_90,w_620/v1479765046/dxcs3ukjgww3inurthon.png', description: 'This is a very nice trumpet', rating: '4'}),
